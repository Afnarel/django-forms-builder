...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'forms_field', 'label', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Field.help_text'
        db.alter_column(u'forms_field', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Field.label'
        db.alter_column(u'forms_field', 'label', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Field.help_text'
        db.alter_column(u'forms_field', 'help_text', self.gf('django.db.models.fields.CharField')(max_length=200))
