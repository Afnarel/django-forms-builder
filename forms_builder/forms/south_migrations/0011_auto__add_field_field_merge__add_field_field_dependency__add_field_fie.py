...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Field.merge'
        db.add_column(u'forms_field', 'merge',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Field.dependency'
        db.add_column(u'forms_field', 'dependency',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Field.condition'
        db.add_column(u'forms_field', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Field.merge'
        db.delete_column(u'forms_field', 'merge')

        # Deleting field 'Field.dependency'
        db.delete_column(u'forms_field', 'dependency')

        # Deleting field 'Field.condition'
        db.delete_column(u'forms_field', 'condition')
    ...
    models = {
        ...
        u'forms.field': {
            ...
            'merge': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'blank': 'True'}),
